...
// import API from "../utils/API"
  ...
  const Signup = (props) => {
    ...
    <div className="form-group">
      ...
      <input type="email" onChange ={props.handleEmail} value={props.email} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"/>
